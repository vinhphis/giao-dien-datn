        ...
        >
            ...
            >
                ...
                >
                    ...
                    <ul
                            class="dropdown-menu dropdown-menu-md p-3"
                            style="width: 35%"
                    ...
                    >
                        ...
                        <li>
                            <a class="dropdown-item w-100" href="#">
                                <i
                                        class="ri-shield-user-fill fs-20 text-primary"
                                ></i>
...
<div class="row">
    <div class="col-12">
        <div
            class="page-title-box d-flex align-items-left justify-content-between"
        >
            <!-- các màn hình trong bảng -->
            <ul
                class="nav nav-pills d-flex justify-content-between align-items-center"
                id="pills-tab"
                role="tablist"
            >
                <li class="nav-item" role="presentation">
                    <a
                        class="nav-link"
                        id="pills-home-tab"
                        href="teams-spaces-overview.html"
                        role="tab"
                        aria-controls="pills-home"
                        aria-selected="true"
                    ><i class="ri-dashboard-line"></i> Overview</a
                    >
                </li>
                <li class="nav-item" role="presentation">
                    <a
                        ...
                        href="teams-spaces-board.html"
                        role="tab"
                        aria-controls="pills-profile"
                        aria-selected="false"
                    ><i class="ri-table-line"></i> Board</a
                    >
                </li>
                <li class="nav-item" role="presentation">
                    <a
                        class="nav-link"
                        id="pills-list-tab"
                        href="teams-spaces-list.html"
                        role="tab"
                        aria-controls="pills-list"
                        aria-selected="false"
                    ><i class="ri-list-unordered"></i> List</a
                    >
                </li>
                <li class="nav-item" role="presentation">
                    <a
                        ...
                        aria-selected="false"
                    ><i class="ri-calendar-line"></i> Calendar</a
                    >
                </li>
                <li class="nav-item" role="presentation">
                    <a
                        ...
                        aria-selected="false"
                    ><i class="ri-menu-2-line"></i> Gantt</a
                    >
                </li>
                <li class="nav-item active" role="presentation">
                    <a
                        class="nav-link"
                        id="pills-table-tab"
                        href="teams-spaces-table.html"
                        role="tab"
                        aria-controls="pills-table"
                        aria-selected="false"
                    ><i class="ri-layout-3-line"></i> Table</a
                    >
                </li>
            </ul>
            <div
            ...
            >
                <!--  bộ lọc -->
                <div
                    class="d-flex justify-content-center align-items-center p-1 cursor-pointer"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                    aria-haspopup="true"
                >
                ...
                >
                    ...
                    <div class="mt-2">
                        ...
                        />
                        <span class="fs-10"
                        >Tìm kiếm các thẻ, các thành viên, các nhãn và hơn thế
                          nữa.</span
                        >
                    </div>
                    <!-- lọc thành viên -->
                    ...
                    <div class="text-center">
                        <button
                            type="submit"
                            class="btn btn-ghost-secondary mt-2"
                        >
                            Lọc
                        </button>
                    </div>
                ...
                <section class="d-flex">
                    ...
                    >
                        <i
                            class="ri-list-settings-line fs-15"
