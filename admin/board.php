...
<style>
    .dropdown-item p {
        overflow-wrap: break-word; /* Cho phép xuống dòng */
        white-space: normal; /* Cho phép nội dung xuống dòng */
        width: 200%; /* Đảm bảo chiều rộng của thẻ p không vượt quá chiều rộng của li */
    }
</style>
<body>
<!-- Begin page -->
    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <?php
                require 'nav-bar-bottom.php';

                ?>
                <?php

                require 'board-setting.php'
